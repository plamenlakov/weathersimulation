...
class Map extends React.Component {
  ...
  render() {
    ...
    if (this.state.dataLoaded === false) {
      ...
      console.log(this.state.bordersLoaded)
    }
    ...
    return (
      ...
      <div>
        ...
        <div className="" id="main_map" style={{ width: 100 + "%", height: 100 + "%" }}>
          {this.state.bordersLoaded ? <div>Map loaded</div> : <h3 className="text-center justify-content-center align-self-center">Loading map<br />
            <Spinner animation="grow"></Spinner>
            <Spinner animation="grow"></Spinner>
            <Spinner animation="grow"></Spinner></h3>}</div>
